...
<input type="date" name="shoosedate" style="border-width: 0px;background-color: red;padding: 10px 15px;color: white"> <input type="submit" name="btn-date"> </form></th>
  ...
  border-width:0;' class='btn btn-primary btn-anim'><i class='icon-check'></i><span class='btn-text'>Report</span></button></a></td>
                            ...
                            if($num_btn1 =='0'){
                            echo "<td>ยังไม่บันทึกข้อมูล</td><td><a href='".base_url()."teacher/check_homeroom/".$r['std_gro1']."'>
  ...
  border-width:0;' class='btn btn-primary btn-anim'><i class='icon-check'></i><span class='btn-text'>Report</span></button></a></td>
                            ...
                            if($num_btn2 =='0'){
                            echo "<td> ยังไม่บันทึกข้อมูล</td><td><a href='".base_url()."teacher/check_homeroom/".$r['std_gro2']."'>
                            <button  class='btn btn-primary btn-anim'><i class='icon-check'></i><span class='btn-text'>Check</span></button></a></td>
                          ...
                          echo "<tr>  
                            ...
                            <td>".$daynow."</td>
                          "; 
                                  if($num_btn3!='0') {echo "<td>บันทึกข้อมูลแล้ว</td>
  ...
  border-width:0;' class='btn btn-primary btn-anim'><i class='icon-check'></i><span class='btn-text'>Report</span></button></a></td>
                            ...
                            if($num_btn3 =='0'){
                            echo "<td> ยังไม่บันทึกข้อมูล</td><td><a href='".base_url()."teacher/check_homeroom/".$r['std_gro3']."'>
                            <button  class='btn btn-primary btn-anim'><i class='icon-check'></i><span class='btn-text'>Check</span></button></a></td>
                          </tr>";
                            }
