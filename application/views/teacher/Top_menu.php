...
<body>
    ...
    <div class="wrapper theme-1-active pimary-color-red">
		...
		$name=$this->session->userdata('name');?>">
				...
				<?php
				$activeterm; 
				$ch_terms = $this->session->userdata('years');
				if($ch_terms==$activeterm){
				?>
				<li>
					<a href='<?php echo base_url();?>teacher/show_lineup' data-toggle="collapse" data-target="#ui_dr"><div class="pull-left"><i class="zmdi zmdi-smartphone-setup mr-20"></i><span class="right-nav-text">กิจกรรมเข้าแถว</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
					
				</li>
				<li>
					<a href='<?php echo base_url();?>teacher/show_homeroom' data-toggle='collapse' data-target='#form_dr'><div class='pull-left'><i class='zmdi zmdi-edit mr-20'></i><span class='right-nav-text'>กิจกรรมโฮมรูม</span></div><div class='pull-right'></div><div class='clearfix'></div></a>
				...
				<li>
					<a href="<?php echo base_url();?>teacher/choose_special" data-toggle="collapse" data-target="#icon_dr"><div class="pull-left"><i class="zmdi zmdi-iridescent mr-20"></i><span class="right-nav-text">กิจกรรมพิเศษ</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
