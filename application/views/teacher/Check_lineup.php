 ...
 <!-- Title -->
        <div class="row heading-bg">
          <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h5 class="txt-dark">เช็คชื่อกิจกรรมเข้าแถว 
  ...
  <a href="<?php echo base_url();?>teacher/room_lineup" class="pull-left inline-block mr-15">
              ...
              <div class="panel-wrapper collapse in">
                <div class="panel-body row">
                  ...
                  <input type="hidden" name="depwork" value="<?php echo $r['depwork'];?>">
