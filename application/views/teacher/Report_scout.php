 ...
 <!-- Title -->
        <div class="row heading-bg">
          <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h5 class="txt-dark">เช็คชื่อกิจกรรมลูกเสือ<?php echo "วันที่  ".$chday=$this->session->userdata('chday'); ?></h5>
          </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="panel panel-default card-view"><div class="pull-right">
                  <a href="<?php echo base_url();?>teacher/show_scout" class="pull-left inline-block mr-15">
